...
export default function Sidebar({ currentPage, setCurrentPage, isOpen, setIsOpen }) {
  const navigation = [
    { name: 'Dashboard', id: 'dashboard', icon: 'Home', link: '/seller-dashboard' },
    { name: 'Products', id: 'products', icon: 'Package', link: '/productmanagement' },
    ...
    { name: 'Inventory', id: 'inventory', icon: 'Package', link: '/inventory' },
    { name: 'Profile', id: 'profile', icon: 'User', link: '/profile' },
  ];

  const getIconComponent = (iconName) => {
    const icons = {
      Home: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-3">
